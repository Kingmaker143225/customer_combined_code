...
// import { createDrawerNavigator } from "@react-navigation/drawer";
// import { createNativeStackNavigator } from "@react-navigation/native-stack";
// import { DrawerActions } from "@react-navigation/native";   // ⬅️ ADDED
// import React from "react";
// import { useSafeAreaInsets } from "react-native-safe-area-context";
// import { useTheme } from "../context/ThemeContext";
...
// /* ================= HELPER: open drawer safely ================= */
// // Reusable helper so both Profile and Bookings listeners share the same logic
// function openDrawerFromTabs(navigation: any) {
...
// function MainTabs() {
//   const { theme } = useTheme();
//   // useAuthGuard no longer needed here — remove the import too
...
//             if (!data.session) {
//               // Not logged in → open drawer (Login / Sign Up button will show)
//               openDrawerFromTabs(navigation);
//               return;
//             }
